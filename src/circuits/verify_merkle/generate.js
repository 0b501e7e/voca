...
const inputs = {
    "leafNode": leaf1.toString(),
    "expectedRoot": root.toString(),
    "siblingHashes": [leaf1Proof[0].toString(),leaf1Proof[1].toString()],
    "siblingPositions": [leaf1Pos[0].toString(), leaf1Pos[1].toString()],
}
