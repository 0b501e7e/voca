...
module.exports = function getCircuitInput(stateTransition){
    ...
    return {
        ...
        senderPathHashes: stringifyBigInts(paths2rootFrom),
        senderPathPositions: paths2rootFromPos,
        receiverPathHashes: stringifyBigInts(paths2rootTo),
        receiverPathPositions: paths2rootToPos,
        senderX: stringifyBigInts(fromX),
        senderY: stringifyBigInts(fromY),
        senderIndex: fromIndex,
        receiverX: stringifyBigInts(toX),
        receiverY: stringifyBigInts(toY),
