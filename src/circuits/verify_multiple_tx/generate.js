...
const AccountTree = require("./utils/accountTree.js");
const Transaction = require("./utils/transaction.js");
const TxTree = require("./utils/txTree.js");
const treeHelper = require("./utils/treeHelper.js");
const getCircuitInput = require("./utils/circuitInput.js");
...
for (var i = 0; i < txs.length; i++){
    ...
    console.log(`TX ${i}: TokenType=${txTokenTypes[i]}`);
